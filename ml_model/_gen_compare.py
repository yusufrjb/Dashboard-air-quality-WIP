...
# Cell 3: Load dataset
cells.append({
    "cell_type": "markdown", "id": "m2", "metadata": {},
    "source": ["### Load Dataset (sama dengan train_classification.ipynb)"]
})
...
# Cell 8: Train + evaluate all
cells.append({
    "cell_type": "markdown", "id": "m3", "metadata": {},
    "source": ["### Train & Evaluate Semua Model"]
})

cells.append({
    "cell_type": "code", "id": "c7", "metadata": {},
    "execution_count": None, "outputs": [],
    "source": [
        "results = []\n",
        "trained_models = {}\n",
...
# Cell 9: Summary bar chart
cells.append({
    "cell_type": "code", "id": "c8", "metadata": {},
    "execution_count": None, "outputs": [],
    "source": [
...
cells.append({
    "cell_type": "code", "id": "c10", "metadata": {},
    "execution_count": None, "outputs": [],
    "source": [
...
# Cell 12: Winner
cells.append({
    "cell_type": "code", "id": "c11", "metadata": {},
    "execution_count": None, "outputs": [],
    "source": [
...
cells.append({
    "cell_type": "code", "id": "c12", "metadata": {},
    "execution_count": None, "outputs": [],
    "source": [
...
with open(r"D:\DashboardAQ_v3\ml_model\compare_classification.ipynb", "w", encoding="utf-8") as f:
